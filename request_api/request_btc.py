...
class bitcoin():
    ...
    async def fetch(self):
        list_json = []
        list_urls = ["https://api.kraken.com/0/public/Ticker?pair=XBTUSD","https://www.bitstamp.net/api/v2/ticker/btcusd",
                     "https://bittrex.com/api/v1.1/public/getmarketsummary?market=usdt-btc","https://api.coinbase.com/v2/prices/spot?currency=USD",
                     "https://api.bitfinex.com/v1/pubticker/btcusd","https://www.bitmex.com/api/v1/instrument?symbol=XBTUSD",
    ...
    def affichage(self,list_json,author):
        ...
        for i in list_json:
            if i[1] == "Kraken":
                try:
                    value = value + "Kraken : " + "{0:.2f}".format(float(i[0]["result"]["XXBTZUSD"]["c"][0])) + "$ [USD]\n"
                except Exception as e:
                    print(e)
            if i[1] == "Bitmex":
                try:
