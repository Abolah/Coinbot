...
class Listsql():
    ...
    def create(self,conn):
        ...
        try:
            c.execute('''   
                CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY , rank INTEGER,
                                   coin TEXT, pseudo TEXT, comment TEXT)
            ''')
            conn.commit()
